...
<div id="admin-page-mining-equipment" class="admin-page">
    <div class="admin-page-header ui inverted blue segment">
        <h1 class="ui inverted header">
            <div class="content">
                Mining Page
                <div class="sub header">
                    Mining equipment page settings
                </div>
            </div>
        </h1>
        ...
        <a href="{{ urls.mining_page }}" target="_blank" class="ui labeled icon button">
        ...
        <div ng-if="settings.enabled">
            ...
            <div class="ui raised segment">
                ...
                <div class="two fields">
                    ...
                    <div class="field">
                        <div class="ui toggle checkbox">
                            <input type="checkbox" ng-model="settings.cc_clickable">
                            <label>Clickable to CryptoCompare</label>
                        </div>
                    </div>
                </div>
