...
<div id="admin-page-icos" class="admin-page">
    <div class="admin-page-header ui inverted blue segment">
        <h1 class="ui inverted header">
            <div class="content">
                ICOs Page
                <div class="sub header">
                    Initial coin offers management
                </div>
            </div>
        </h1>
        ...
        <a href="{{ urls.icos_page }}" target="_blank" class="ui labeled icon button">
    ...
    <div class="admin-page-content">
        ...
        <div ng-if="settings.enabled">
            ...
            <div class="ui raised segment">
                <div class="ui header">Custom ICOs</div>
                <p>ICOs without start/end dates will not be displayed.</p>
                <admin-custom-icos icos="settings.custom_icos"></admin-custom-icos>
            </div>
